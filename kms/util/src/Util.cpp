...
const int defaultPortNumber(int serviceType) {
    switch (serviceType) {
        ...
        case KEYRELAYAGENT: return KEYRELAYAGENT_DEFAULT_PORT;
...
std::string servicesListStrings(int serviceType) {
    switch (serviceType) {
      ...
      case KEYRELAYAGENT: return STRINGIFY_ENUM(KEYRELAYAGENT);
...
const std::string getServicesStrings(int serviceType) {
    switch (serviceType) {
        ...
        case KEYRELAYAGENT: return STRINGIFY_LOWER_CASE(KEYRELAYAGENT);
